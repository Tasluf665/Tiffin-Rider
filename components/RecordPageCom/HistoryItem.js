...
export default function HistoryItem({ orderNo, name, location, bill, payment, order }) {
    return (
            ...
            <View style={styles.rightContainer}>
                ...
                <TouchableOpacity
                    ...
                    style={{
                        ...styles.dateContainer,
                        ...{
                            backgroundColor: order ? Colors.pink : Colors.Red,
                            borderColor: order ? Colors.pink : Colors.Red,
                            flexDirection: "row",
